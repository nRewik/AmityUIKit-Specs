Pod::Spec.new do |s|
    ...
    s.source       = { :http => 'https://s3-ap-southeast-1.amazonaws.com/ekosdk-release/ios-uikit/2.4.3/uikit.zip' }
    s.vendored_frameworks = 'Distribution/AmityUIKit.xcframework', 'Distribution/AmitySDK.xcframework'
